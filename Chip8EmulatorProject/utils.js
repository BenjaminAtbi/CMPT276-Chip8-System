...
class Execution {
    constructor(opcode) {
        this.opcode = opcode;
        this.instruction = OpcodeManager.getOpcode(opcode);
        
    }

    execute(chip8){

        this.beforestate = instruction.SaveState(chip8);
        instr.execute;
        this.afterstate = instruction.SaveState(chip8);
    }
}
